    ...
    public class WpPlanProfile : Profile
    {
        public WpPlanProfile()
        {
            CreateMap<WpPlan, WPPlanDAO>()
                ...
                .ForMember(dao => dao.PL_START_DATE, e => e.MapFrom(o => ConvertToDateTime(o, o.PL_START_AT, nameof(o.PL_START_AT))))
                .ForMember(dao => dao.ACT_START_DATE, e => e.MapFrom(o => ConvertToDateTime(o, o.ACT_START_AT, nameof(o.ACT_START_AT))))
                .ForMember(dao => dao.PL_END_DATE, e => e.MapFrom(o => ConvertToDateTime(o, o.PL_END_AT, nameof(o.PL_END_AT))))
                .ForMember(dao => dao.ACT_END_DATE, e => e.MapFrom(o => ConvertToDateTime(o, o.ACT_END_AT, nameof(o.ACT_END_AT))))
